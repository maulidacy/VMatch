      ...
      <div className="mx-auto max-w-[1180px] px-6">
        <div className="relative z-20 -mt-24 grid gap-6 md:-mt-32 md:grid-cols-3 md:gap-8">
          {steps.map((step) => (
            <article 
              key={step.number} 
              className="flex flex-col items-center rounded-2xl bg-white px-6 py-10 text-center shadow-xl shadow-black/5 ring-1 ring-black/[0.04] transition-transform duration-300 hover:-translate-y-1 sm:px-8"
            >
