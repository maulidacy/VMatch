    ...
    <section className="overflow-hidden bg-white py-14 md:py-20">
      <div className="mx-auto grid max-w-[1320px] items-center gap-10 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:gap-14">
          ...
          <div className="mt-9 grid grid-cols-1 gap-4 sm:grid-cols-2">
            {features.map((feature, index) => (
              <AnimateIn
                ...
                className="h-full"
              >
                <article className="group relative h-full overflow-hidden bg-[#6b5b52] px-6 py-7 text-center shadow-[0_14px_34px_rgba(49,51,44,0.14)] transition-all duration-500 hover:-translate-y-2 hover:bg-[#58483f] hover:shadow-[0_24px_55px_rgba(49,51,44,0.22)]">
                  <div className="relative z-10 mx-auto grid h-12 w-12 place-items-center bg-white/10 text-white ring-1 ring-white/25 transition-all duration-500 group-hover:rotate-6 group-hover:scale-110 group-hover:bg-white/15">
        ...
        <AnimateIn direction="left" delay={0.2} duration={0.75}>
          <div className="relative min-h-[360px] overflow-hidden bg-[#eee9e3] shadow-[0_18px_50px_rgba(0,0,0,0.10)] sm:min-h-[430px] lg:min-h-[520px]">
            <Image
            ...
            <div className="absolute bottom-5 left-5 right-5 bg-white/90 p-5 shadow-[0_16px_40px_rgba(0,0,0,0.14)] backdrop-blur-md sm:p-6">
